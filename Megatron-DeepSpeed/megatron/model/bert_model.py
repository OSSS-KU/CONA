...
def post_language_model_processing(lm_output, pooled_output,
    ...
    if lm_labels is None:
        ...
        if return_lm_logits:
            # Keep lm_logits in [s, b, vocab] (vocab-parallel) format.
            return lm_loss, binary_logits, lm_logits
        return lm_loss, binary_logits, None
...
class BertModel(MegatronModule):
    ...
    def forward(self, bert_model_input, attention_mask,
        ...
        if self.post_process:
            ...
            # BERT-only optional: return logits for metrics (e.g., masked-token accuracy).
            # Default off to avoid extra overhead; enabled by env var.
            import os as _os
            return_lm_logits = (_os.environ.get("BERT_RETURN_LM_LOGITS", "0") == "1")
